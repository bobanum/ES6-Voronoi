...
export default class Voronoi {
	...
	equalWithEpsilon = (a, b) => this.abs(a - b) < Voronoi.ε;
	greaterThanWithEpsilon = (a, b) => a - b > Voronoi.ε;
	greaterThanOrEqualWithEpsilon = (a, b) => b - a < Voronoi.ε;
	lessThanWithEpsilon = (a, b) => b - a > Voronoi.ε;
	lessThanOrEqualWithEpsilon = (a, b) => a - b < Voronoi.ε;
